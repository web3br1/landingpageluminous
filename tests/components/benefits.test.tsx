...
vi.mock('lucide-react', () => ({
  ...
  Rocket: ({ className, ...props }: { className?: string; [key: string]: unknown }) =>
    React.createElement('svg', {
  ...
  DollarSign: ({ className, ...props }: { className?: string; [key: string]: unknown }) =>
    React.createElement('svg', {
  ...
  Building: ({ className, ...props }: { className?: string; [key: string]: unknown }) =>
    React.createElement('svg', {
...
describe('Benefits Component', () => {
  ...
  const mockBenefits = [
    {
      ...
      description: 'Automatize processos manuais e foque no que realmente importa',
      metric: '300%'
    },
    {
      icon: 'TrendingUp',
  ...
  describe('Rendering', () => {
    it('deve exibir título e subtítulo da seção de benefícios', () => {
    ...
    it('deve renderizar todos os benefícios com conteúdo correto', () => {
      render(<Benefits {...defaultProps} />)
    ...
    it('deve exibir ícones para cada benefício', () => {
      render(<Benefits {...defaultProps} />)
  ...
  describe('Interactions', () => {
    ...
    it('supports keyboard navigation and interaction', () => {
      ...
      const benefitCard = document.querySelector('[data-benefit-index="0"]') as HTMLElement
      expect(benefitCard).toBeInTheDocument()
  ...
  describe('Accessibility & UX', () => {
    it('provides proper ARIA labels and roles', () => {
      ...
      expect(screen.getByRole('heading', { level: 2 })).toHaveTextContent(mockContent.title)
  ...
  describe('Edge Cases & Error Handling', () => {
    ...
    it('handles benefits without metrics', () => {
      ...
      const emptyMetricBadges = metricBadges.filter(el =>
