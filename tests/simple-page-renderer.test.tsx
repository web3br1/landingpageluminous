  ...
  sections: [
    {
      ...
      content: {
        content: {
          content: {
            headline:
              "Automatize seus processos empresariais com IA inteligente.",
            subheadline:
...
describe("PageRenderer", () => {
  it("should render without crashing", async () => {
    ...
    render(<PageRenderer composition={mockComposition} pageType="landing" />);
  ...
  it("should render simple inline styles without CSS dependencies", async () => {
  ...
  it("should render hero section content after lazy loading", async () => {
    ...
    await waitFor(
      () => {
        const heroHeadline = screen.getByText(
          "Automatize seus processos empresariais com IA inteligente.",
        );
