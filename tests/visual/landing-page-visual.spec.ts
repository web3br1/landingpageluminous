...
test.describe('Landing Page Visual Regression', () => {
  ...
  test('@visual-regression should match hero section visual baseline', async ({ page }) => {
    await page.goto('/');
  ...
  test('@visual-regression should match features section visual baseline', async ({ page }) => {
    await page.goto('/');
    ...
    // Take screenshot
    await expect(page.locator('[data-testid="features-section"]')).toHaveScreenshot(
      'features-section-baseline.png',
      {
        threshold: 0.1,
        fullPage: false,
      }
  ...
  test('@visual-regression should match pricing section visual baseline', async ({ page }) => {
    await page.goto('/');
