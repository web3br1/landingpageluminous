...
test.describe("Critical User Paths", () => {
  test("@critical-path should complete landing page to signup flow", async ({
    page,
  }) => {
  ...
  test("@critical-path should handle pricing to checkout flow", async ({
    page,
  }) => {
    const startTime = Date.now();
  ...
  test("@critical-path should handle mobile critical flow", async ({
    page,
  }) => {
    // Set mobile viewport
  ...
  test("@critical-path should handle error recovery in critical flows", async ({
    page,
  }) => {
