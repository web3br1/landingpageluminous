...
import { experimentManager, ExperimentManager } from '@/lib/ab-testing/ab-testing-framework'
...
describe('ExperimentManager', () => {
  ...
  it('should load experiments from registry', async () => {
    ...
    const { experimentManager: freshManager } = await import('@/lib/ab-testing/ab-testing-framework')
  ...
  it('should assign variants to users', async () => {
    ...
    const variant1Again = freshInstance.assignVariant('assignment-test', 'user1')
