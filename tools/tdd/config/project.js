    ...
    M0: {
      ...
      metrics: {
        ...
        quality: {
          min: 0,
          target: 50,
          weight: 0.30     // Peso em qualidade básica
        }
      },
  ...
  experiments: {
    ...
    'landing-page-weights': {
      ...
      variants: [
        {
          name: 'ui-focused',
          weights: { coverage: 0.15, isolation: 0.25, performance: 0.20 }
        },
        {
          name: 'conversion-focused',
          weights: { coverage: 0.20, isolation: 0.20, performance: 0.25 }
        }
      ]
    },
