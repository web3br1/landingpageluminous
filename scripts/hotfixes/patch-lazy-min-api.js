...
const lazyLoadingPath = path.join(process.cwd(), 'lib', 'composition', 'performance', 'route-based-lazy-loading.tsx');
...
`;
  ...
  console.log('   - Adicionados exports diretos: shouldLazyLoad, getChunkId, traceLazyLoad, prefetch, load');
